...
//		default values
		...
		System.out.println("svm train started");
		svm_model classifier = svm.svm_train(problem, param);
		System.out.println("svm train ended");
	...
	public void loadFromString(String model) {
	  ByteArrayInputStream bais = 
	    new ByteArrayInputStream(Base64.getDecoder().decode(model.getBytes()));
